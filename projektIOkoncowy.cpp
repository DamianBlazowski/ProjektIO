...
public:
    ...
    void wypiszCzyZaplacono()
    {
        if (czyOplacono == false)
        {
            cout << "Nie opłacono" << endl;
        }
        else
            cout << "Opłacono" << endl;
    }
...
void menuKlienta()
{
    ...
    cout << "4 - Dokonaj oplaty" << endl;
    cout << "5 - Usuniecie konta" << endl;
    cout << "6 - Wyjdz" << endl;
    cout << "Wybor: ";
}
...
void stanWypozyczenia()
{
    ...
    do
    {
        ...
        for (int i = 0; i < wybrane; i++)
        {
            cout << "Nr. " << i + 1;
            wybraneSamochody[i].Wypisz();
            cout << "Ilość dni: " << wybraneSamochody[i].getIloscDni() << ", czyli ogółem: " << wybraneSamochody[i].getCena() * wybraneSamochody[i].getIloscDni() << " zł ";
            CO[i].wypiszCzyZaplacono();
        }
        cout << "Cena za wszystko: " << cenaZaWszystko << " zł" << endl;
        wybor = getInput();
        if (wybor == 0)
        {
            break;
...
void dokanajOplaty()
{
    ...
    do
    {
        ...
        for (int i = 0; i < wybrane; i++)
        {
            cout << "Nr. " << i + 1;
            wybraneSamochody[i].Wypisz();
            cout << "Ilość dni: " << wybraneSamochody[i].getIloscDni() << ", czyli ogółem: " << wybraneSamochody[i].getCena() * wybraneSamochody[i].getIloscDni() << " zł" << endl;
        }
        cout << "Cena za wszystko: " << cenaZaWszystko << " zł" << endl;
        cout << "Który samochód chcesz opłacić?" << endl;
        wybor = getInput();
        if (wybor == 0)
        {
            break;
        ...
        cout << "Opłacono!" << endl;
        CO[wybor - 1].czyZaplacono(wybor);
        tablicaOplat[wybor - 1] = 1;
        cenaZaWszystko -= wybraneSamochody[wybor - 1].getCena() * wybraneSamochody[wybor - 1].getIloscDni();
        if (cenaZaWszystko < 0)
        {
            cenaZaWszystko = 0;
        }
